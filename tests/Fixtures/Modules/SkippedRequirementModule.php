...
final class SkippedRequirementModule implements IsModule
{
    public function module(): Module
    {
        return Module::make('tests::skipped-requirement', '1.0.0')
            ->requirements(function (Requirements $requirements): void {
                $requirements->add(
                    (new Callback(
                        callback: fn (): bool => false,
                        name: 'Skipped requirement',
                        failMessage: 'This requirement should be skipped.',
