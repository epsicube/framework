...
<Tabs>
  ...
  <TabItem label="Existing Application">
    ...
    2. ### Register the Epsicube service provider
        Epsicube integrates into the native Laravel application builder through `withProviders()`.
