...
1. ### Implement the Interface
   ...
   Your module must implement the [`UniGale\Support\Contracts\HasDependencies`](https://github.com/unigale/framework/blob/main/packages/Support/Contracts/HasDependencies.php) interface.
    ...
    class BrandingModule extends ServiceProvider implements HasDependencies, Module
    {
        ...
        {
            return Dependencies::make(['core::execution-platform']);
        }
    }
    ```
