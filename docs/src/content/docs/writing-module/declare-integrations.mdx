...
1. ### Implement the Interface
   Your module must implement the [`UniGale\Support\Contracts\HasIntegrations`](https://github.com/unigale/framework/blob/main/packages/Support/Contracts/HasIntegrations.php) interface.
