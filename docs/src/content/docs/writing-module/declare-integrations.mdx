...
1. ### Implement the Interface
   Your module must implement the [`UniGale\Foundation\Contracts\HasIntegrations`](https://github.com/unigale/framework/blob/main/packages/Foundation/Contracts/HasIntegrations.php) interface.
...
2. ### Understand Integrations
   ...
   | `whenEnabled`  | A closure executed **only when the target module is enabled**. <br/>Use it to extend functionality or interact with the module’s APIs.    |
