...
1. ### Implement the Interface
   Your module must implement the [`UniGale\Support\Contracts\HasOptions`](https://github.com/unigale/framework/blob/main/packages/Support/Contracts/HasOptions.php) interface.
